...
const IndexPage = () => (
  <Layout active="Projects">
    ...
    <div style={{marginBottom: 40}}>
      ...
      <ProjectBox name="Star Trek" > Take over the bridge of the Starship Enterprise, and communicate with your teammates to defend against Klingon attacks.  Played by hundreds of people at Spring Carnival 2018. </ProjectBox>
      ...
      <ProjectBox name="Frequent Transit" link="/frequent/"> An automatic frequent transit map generator, telling you where you can go when you want to go on transit. </ProjectBox>
      <ProjectBox src={ddeLogo} name="Dance Dance Evolution" > A room-sized version of Dance Dance Revolution using computer vision.  Cooperate with your teammates to pull off big dance moves. </ProjectBox>
      <ProjectBox name="Cloud Chambers"> A new way to automatically detect subatomic particles moving through cloud chambers, resulting in a particle detector anyone could build at home.  </ProjectBox>
    </div>
