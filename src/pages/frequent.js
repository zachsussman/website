  ...
  render () {
    return (
      <Layout active="Frequent Transit"> 
        <h1 style={{textAlign: "center"}}>Automatically Generated Frequent Transit Maps</h1>
        ...
        <div className="col-xs-10 col-xs-offset-1">
          ...
          <p>
            ...
            In fact, Jarrett Walker, an experienced transit planner with his own blog called <a href="http://humantransit.org">Human Transit</a>, often says:
          </p>
          ...
          <p>
            Jarrett Walker was also one of the first people to <a href="http://humantransit.org/2010/08/basics-the-case-for-frequency-mapping.html">
